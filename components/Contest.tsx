...
const ContestProjectDetail = ({ project }: { project: Project }) => {
  return (
        <>
      <Navbar />
    <div className="max-w-[1280px] mx-auto px-6 py-20 font-poppins">
      <ScrollReveal>
        <h1 className="text-[48px] font-bold text-[#ED950A] mt-10 mb-4">{project.title}</h1>
        <p className=" text-gray-700 mb-10">{project.overview}</p>
      </ScrollReveal>  

      <ScrollReveal>
        <h2 className="text-[24px] font-semibold text-[#184585] mb-4">Goals</h2>
      ...
      <ScrollReveal>
        <h2 className="mt-10 text-[24px] font-semibold text-[#184585] mb-4">Design Process</h2>
        <ul className="list-disc pl-5 text-gray-700">
      ...
      {Array.isArray(project.softwareUsed) && project.softwareUsed.length > 0 && (
        <ScrollReveal delay={0.3}>
          ...
          <div className="flex items-center mb-4 gap-2 mt-10">
              <div className="w-4 h-4 rounded-full bg-[#BAC7DA] flex items-center justify-center">
              <div className="w-2 h-2 bg-[#184585] rounded-full block"></div>
              </div>              

              <h2 className="text-xl font-semibold text-[#184585]">Softwares Used</h2>
          </div>
          <ul className="list-disc pl-5 text-gray-700">
        ...
        <ScrollReveal delay={0.3}>
          <section className="mt-10">
            <div className="flex items-center mb-4 gap-2">
              <div className="w-4 h-4 rounded-full bg-[#BAC7DA]  flex items-center justify-center">
                <div className="w-2 h-2 bg-[#184585] rounded-full "></div>
              </div>
              <h2 className="text-xl font-semibold text-[#184585]">Colors Used</h2>
            </div>
    ...
    <div className="flex flex-wrap gap-6">
      ...
      {project.reflection && (
        <ScrollReveal delay={0.4}>
          <div className="mt-10 p-4 bg-[#ecc37fff] rounded-lg shadow">
            <h3 className="font-semibold text-[#004225] mb-2">Feedback Received</h3>
