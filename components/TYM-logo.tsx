...
const TYMProjectDetail = ({ project }: { project: Project }) => {
  return (
        <>
      <Navbar />
  ...
  <ScrollReveal delay={0.2}>
    ...
    <div className="flex flex-wrap gap-6">
      {project.variations.map((img, i) => (
        <div
          key={i}
          className="w-[500px] h-[500px] bg-white rounded-xl shadow-md flex items-center justify-center"
        >
          <Image
            src={img}
...
export default TYMProjectDetail;
