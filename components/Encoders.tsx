...
const EncodeProjectDetail: React.FC<Props> = ({ project }) => {
  return (
    <>
      <Navbar />
<div className="max-w-[1280px] mx-auto px-6 md:px-12 lg:px-20 py-20 text-[#111] font-poppins">
        ...
        {/* Title Section */}
        <ScrollReveal>
          <div className="flex justify-between items-start mb-[140px] mt-[60px]">
            <div>
              <h1 className="text-[44px] font-bold text-[#0F2840]  uppercase leading-none">
                {project.title}
              </h1>
              {project.subtitle && (
                <p className="text-[22px] font-normal  uppercase text-black mt-[2px]">
                  {project.subtitle}
                </p>
              )}
            </div>
            {/* Logo */}
            <div className="w-[246px] h-[66px] flex items-center justify-center">
            <img
        ...
        <ScrollReveal delay={0.1}>
          <section className="mb-2">
            <h2 className="text-[26px] font-medium uppercase mb-4">
              PROJECT <span className="text-[#0F2840]">OVERVIEW</span>
            </h2>
        ...
        <ScrollReveal delay={0.3}>
          <section className="mb-20 grid md:grid-cols-3 gap-10 items-center">
            <div className="md:col-span-2">
              <h2 className="text-[26px] font-medium uppercase mb-4">
                PROBLEM <span className="text-[#0F2840]">STATEMENT</span>
              </h2>
        ...
        {/* The Goals*/}
                <ScrollReveal delay={0.4}>
                  <section className="mb-20">
                      <h2 className="text-[26px] font-medium uppercase mb-4">
                        The <span className="text-[#0F2840]">Goals</span>
                      </h2>
        ...
        <ScrollReveal delay={0.5}>
          <section className="mb-20">
            <h2 className="text-[26px] font-medium uppercase mb-6">
              TYPOGRAPHY <span className="text-[#0F2840]">& COLORS</span>
            </h2>
            <div className="grid md:grid-cols-2 gap-10">
              <div>
                <div className="flex items-center mb-4 gap-2">
                  <div className="w-4 h-4 rounded-full bg-[#C5C9DE] flex items-center justify-center">
                    <div className="w-2 h-2 bg-[#0F2840] rounded-full"></div>
                  </div>
            ...
            <section className="mt-10">
              ...
              <div className="flex justify-start gap-6 flex-wrap">
                {[{ hex: "#0F2840", label: "Primary" },{ hex:     "#F4D7B4", label: "Secondary" }, 
                  { hex: "#EAEAEA", label: "bg-color" }].map((color, index) => (
        ...
        <ScrollReveal delay={0.6}>
          <section>
            <h2 className="text-[26px] font-medium mb-12">
              The <span className="text-[#0F2840]">Design</span>
            </h2>
        ...
        <ScrollReveal delay={0.7}>
            ...
            <a
              href="https://www.figma.com/proto/Iv1vkiL0AhGa5QkEPPbdFS/Encodersden?page-id=0%3A1&node-id=11-19721&viewport=248%2C17%2C0.43&t=qB0sjMeS9iZCyNQg-8&scaling=scale-down-width&content-scaling=fixed&starting-point-node-id=8%3A21477&hide-ui=1"
              target="_blank"
...
export default EncodeProjectDetail;
