...
const EidProjectDetail = ({ project }: { project: Project }) => {
  return (
        <>
      <Navbar />
    <div className="max-w-[1280px] mx-auto px-6 py-20 font-poppins">
      <ScrollReveal>
        <h1 className="text-[54px] font-bold text-[#D4AF37] mb-4">{project.title}</h1>
      ...
      {Array.isArray(project.softwareUsed) && project.softwareUsed.length > 0 && (
        <ScrollReveal delay={0.3}>
          ...
          <div className="flex items-center mb-4 gap-2 mt-10">
              ...
              <h2 className="text-xl font-semibold text-[#001F3F]">Softwares Used</h2>
            </div>
          <ul className="list-disc pl-5 text-gray-700">
  ...
  <ScrollReveal delay={0.2}>
    <h2 className="mt-10 text-[24px] font-semibold text-[#001F3F] mb-4">Posters</h2>
    <div className="flex flex-wrap gap-6">
      {project.variations.map((img, i) => (
        <div
          key={i}
          className="w-[600px] h-[600px] bg-white rounded-xl shadow-md flex items-center justify-center"
        >
          <Image
            src={img}
      ...
      {project.reflection && (
        <ScrollReveal delay={0.4}>
          <div className="mt-10 p-4 bg-[#d8c589ff] rounded-lg shadow">
...
export default EidProjectDetail;
