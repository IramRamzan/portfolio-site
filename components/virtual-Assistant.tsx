...
const VirtualProjectDetail: React.FC<Props> = ({ project }) => {
  return (
    <>
      <Navbar />
<div className="max-w-[1280px] mx-auto px-6 md:px-12 lg:px-20 py-20 text-[#111] font-poppins">
        ...
        <ScrollReveal>
          <div className="flex justify-between items-start mb-[140px] mt-[20px]">
            <div>
              <h1 className="text-[58px] font-bold text-[#E65612] tracking-[-2.32px] uppercase leading-none">
                {project.title}
              </h1>
              {project.subtitle && (
                <p className="text-[22px] font-normal tracking-[2.32px] uppercase text-black mt-[2px]">
                  {project.subtitle}
                </p>
              )}
            </div>
        ...
        <ScrollReveal delay={0.1}>
          <section className="mb-14">
            <h2 className="text-[26px] font-medium uppercase mb-4">
              PROJECT <span className="text-[#E65612]">OVERVIEW</span>
            </h2>
        ...
        <ScrollReveal delay={0.3}>
          <section className="mb-20 grid md:grid-cols-3 gap-10 items-center">
            <div className="md:col-span-2">
              <h2 className="text-[26px] font-medium uppercase mb-4">
                PROBLEM <span className="text-[#E65612]">STATEMENT</span>
              </h2>
        ...
        {/* The Goals*/}
                <ScrollReveal delay={0.4}>
                  <section className="mb-20">
                      <h2 className="text-[26px] font-medium uppercase mb-4">
                        The <span className="text-[#E65612]">Goals</span>
                      </h2>
        ...
        <ScrollReveal delay={0.5}>
          <section className="mb-20">
            <h2 className="text-[26px] font-medium uppercase mb-6">
              TYPOGRAPHY <span className="text-[#E65612]">& COLORS</span>
            </h2>
            <div className="grid md:grid-cols-2 gap-10">
              <div>
                <div className="flex items-center mb-4 gap-2">
                  <div className="w-4 h-4 rounded-full bg-[#F1592930] flex items-center justify-center">
                    <div className="w-2 h-2 bg-[#E65612] rounded-full"></div>
                  </div>
                  <span className="text-md font-semibold">Font Used</span>
                </div>
                <h3 className="text-2xl font-bold text-[#E65612] mb-2">{project.typography?.fontUsed}</h3>
            ...
            <section className="mt-10">
              ...
              <div className="flex justify-start gap-6 flex-wrap">
                {[{ hex: "#E65612]", label: "Primary" }, 
                  { hex: "#FED7C4", label: "Secondary" }, 
        ...
        <ScrollReveal delay={0.6}>
          <section>
            <h2 className="text-[26px] font-medium mb-12">
              The <span className="text-[#E65612]">Design</span>
            </h2>
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
              {project.wireframes?.map((img, i) => {
                const isWeb = img.includes("virtual2"); 
                return (
                  <div
                    key={i}
                    className={`rounded-2xl overflow-hidden drop-shadow-md ${
                      isWeb ? 'col-span-2 md:col-span-2 lg:col-span-3' : ''
                    }`}
                  >
                    <Image
                      src={img}
        ...
        <ScrollReveal delay={0.7}>
          <div className="flex justify-between items-center mt-20 px-4 sm:px-12">
            <a
              href="https://www.figma.com/proto/D7tOgqOOR5l3Jh1hxtjL27/Virtual-Assistant?page-id=0%3A1&node-id=2-31&p=f&viewport=-932%2C200%2C0.41&t=eFyqkwi3YhNKTcXD-1&scaling=scale-down&content-scaling=fixed&starting-point-node-id=2%3A31"
              target="_blank"
              rel="noopener noreferrer"
              className="text-lg sm:text-xl text-gray-800 hover:underline"
            >
              View App Landing Page prototype ↗
            </a>
             <a
              href="https://www.figma.com/proto/lXOKInOgN5KyJnsrxz0MPZ/Practice?page-id=0%3A1&node-id=9-389&viewport=-608%2C807%2C0.05&t=THtwh08XcWrC32ul-8&scaling=scale-down-width&content-scaling=fixed&starting-point-node-id=13%3A870&hide-ui=1"
              target="_blank"
              rel="noopener noreferrer"
              className="text-lg sm:text-xl text-gray-800 hover:underline"
            >
              View Website Landing Page prototype ↗
            </a>
          </div>
...
export default VirtualProjectDetail;
