...
const LogoProjectDetail = ({ project }: { project: Project }) => {
  return (
        <>
      <Navbar />
  ...
  <ScrollReveal delay={0.2}>
    <h2 className="mt-10 text-[24px] font-semibold text-[#001F3F] mb-4">Logo Variants</h2>
...
export default LogoProjectDetail;
